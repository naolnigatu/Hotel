...
import { X, Trash2, Plus, Minus, ShoppingBag, ArrowRight, UtensilsCrossed, Hotel, ShoppingCart } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {cartItems.length === 0 ? (
            ...
            cartItems.map(({ item, quantity, notes }) => (
              <div 
                key={item.id} 
                className="bg-neutral-50 p-3.5 rounded-xl border border-neutral-200 flex gap-3.5 items-start"
              >
                <img 
        ...
        {cartItems.length > 0 && (
          <div className="p-5 border-t border-neutral-200 bg-neutral-50 space-y-3">
            ...
            <div className="flex gap-2 pt-2">
              <button
                onClick={clearCart}
                className="px-3 py-3 border border-neutral-300 hover:bg-neutral-200 text-neutral-700 rounded-xl text-xs font-bold transition"
              >
                Clear
              </button>
              ...
              <button
                ...
                className="flex-1 py-3 px-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold text-sm transition flex items-center justify-center gap-2 shadow-md"
              >
